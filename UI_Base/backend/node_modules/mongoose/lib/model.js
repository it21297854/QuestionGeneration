 ...
 *     await User.collection.createIndex({ age: 1 }); // Index is not in schema
 ...
 *     const schema = new Schema({ name: { type: String, unique: true } });
 *     const User = mongoose.model('User', schema);
 *     await User.createSearchIndex({ name: 'test', definition: { mappings: { dynamic: true } } });
 *
 ...
 *     const schema = new Schema({ name: { type: String, unique: true } });
 *     const User = mongoose.model('User', schema);
 *     await User.updateSearchIndex('test', { mappings: { dynamic: true } });
 *
 * @param {String} name
 ...
 *     const schema = new Schema({ name: { type: String, unique: true } });
 *     const User = mongoose.model('User', schema);
 *     await User.dropSearchIndex('test');
 *
 * @param {String} name
 * @return {Promise}
 * @api public
 ...
 *
 *     await User.createSearchIndex({ name: 'test', definition: { mappings: { dynamic: true } } });
 *     const res = await User.listSearchIndexes(); // Includes `[{ name: 'test' }]`
 *
